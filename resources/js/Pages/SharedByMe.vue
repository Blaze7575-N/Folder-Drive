    ...
    <AuthenticatedLayout>
        ...
        <nav class="flex items-center justify-between p-1 mt-10 mb-3">
            ...
            <div class="flex gap-4">
                ...
                <DownloadButton :all="allSelected" :ids="selectedIds" :sharedWithMe="true"/>
                <TrashButton
            ...
            <table class="min-w-full mt-0">
                <thead>
                    <tr class="bg-gray-400 border-b">
                        ...
                        <th
                            class="min-w-[500px] text-sm font-medium text-gray-900 px-6 py-4 text-left"
                        >
                            Name
                        </th>
                        <th
...
function openFolder(file) {
    ...
    // console.log("owner_id", file.created_by );
    router.visit(route("SBMe", { folder: file.path }),{
        data:{
